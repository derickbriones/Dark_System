...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $update_query = "UPDATE product SET ProductName = ?, Category = ?, Price = ?, StockQuantity = ?, SellerID = ? WHERE ProductID = ?";
  $stmt = $conn->prepare($update_query);
  $stmt->bind_param("ssdiii", $product_name, $category, $price, $stock, $seller_id, $product_id);
